...
const Glance = () => {
  ...
  return (
    <div className="flex flex-col px-6 py-20 bg-black text-blue-50">
      ...
      <div>
        ...
        <div className="flex lg:flex-row lg:gap-x-8 flex-col gap-y-8 justify-center">
          ...
          <div className="flex flex-col gap-y-8 items-center lg:items-end lg:pt-[100px]">
            ...
            <div className="w-[350px] lg:w-[500px] h-[63vh] lg:h-[90vh] z-10 bg-[rgb(88,68,252)] hover:scale-105 transition-transform duration-500 rounded-lg relative">
              <div className="h-[30%]">
          ...
          <div className="flex flex-col gap-y-8 items-center lg:items-start">
            ...
            <div className="w-[350px] lg:w-[500px] h-[250px] lg:h-[300px] bg-blue-50 rounded-lg hover:scale-105 transition-transform duration-500  p-3 relative">
              <div className="w-1/2 items-start">
